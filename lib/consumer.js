...
/**
 * Defines the "Consumer" class, representing RabbitMQ consumers.
 * @module lib/consumer
 */
...
class Consumer extends EventEmitter {
	 ...
	 * @fires module:lib/consumer~Consumer#ackError
	 */
	ack(msg) {
		try {
			 ...
			 * @event module:lib/consumer~Consumer#ackError
			 * @type {object}
	 ...
	 * @param {object} msg - The RabbitMQ message to acknowledge.
	 * @fires module:lib/consumer~Consumer#nackError
	 */
	nack(msg) {
		try {
			if (this.outstandingMessages.has(`${this.topic}_${msg.properties.messageId}`)) {
			 ...
			 * @event module:lib/consumer~Consumer#nackError
			 * @type {object}
			 * @property {string} topic - The message's routing key.
			 * @property {string} messageId - The unique id of the message.
			 * @property {error} err - The error.
	 ...
	 * @param {object} msg - The RabbitMQ message to acknowledge.
	 * @fires module:lib/consumer~Consumer#rejectError
	 */
	reject(msg) {
		try {
			if (this.outstandingMessages.has(`${this.topic}_${msg.properties.messageId}`)) {
			 ...
			 * @event module:lib/consumer~Consumer#rejectError
			 * @type {object}
			 * @property {string} topic - The message's routing key.
			 * @property {string} messageId - The unique id of the message.
			 * @property {error} err - The error message.
	 ...
	 * @returns {promise}
	 * @fires module:lib/consumer~Consumer#sendReply
	 * @fires module:lib/consumer~Consumer#handlerError
	 */
	async handleMessage(msg) {
		...
		try {
			...
			if (msg.properties.replyTo && msg.properties.correlationId) {
				 ...
				 * @event module:lib/consumer~Consumer#sendReply
				 * @type {object}
				 * @property {string} topic - The message's routing key.
			 ...
			 * @event module:lib/consumer~Consumer#handlerError
			 * @type {object}
			 * @property {string} topic - The message's routing key.
			 * @property {string} messageId - The unique id of the message.
			 * @property {error} err - The error.
	...
	startConsuming() {
		this.consumeSetup = async (channel) => {
			...
			const result = await channel.consume(this.topic, this.handleMessage.bind(this), options);
