...
class Transport extends EventEmitter {
	 ...
	 * @returns {Promise} - Resolves when the transport is successfully connected.
	 */
	connect() {
	 ...
	 * @returns {Promise} - Resolves when the transport is successfully disconnected.
	 */
	disconnect() {
	 ...
	 * @returns {string} - The converted routing key.
	 */
	 ...
	 * @returns {Promise} - Resolves to the wrapped handler function that was added.
	 */
	 ...
	 * @returns {Promise} - Resolves when the listener has been successfully removed.
	 */
	 ...
	 * @returns {Promise} - Resolves when the transport has started listening.
	 */
	listen() {
		return new Promise((resolve) => {
			this.listening = true;
	 ...
	 * @param {object} [options.correlationId] - Optional marker used for tracing requests through the system.
	 * @param {object} [options.initiator] - Optional marker used for identifying the user who generated the initial request.
	 * @returns {Promise} - Resolves when the message has been successfully sent.
	 */
	 ...
	 * @param {object} [options.correlationId] - Optional marker used for tracing requests through the system.
	 * @param {object} [options.initiator] - Optional marker used for identifying the user who generated the initial request.
	 * @returns {Promise} - Resolves to the message response.
	 */
